...
!!! warning "This page contains important information you should read before installing. But here is the summary:"
    ...
    - Computers with old or slow CPUs may have trouble running the game - [Poor Performance FAQ](http://127.0.0.1:8000/Umineko/Umineko-Part-0-TroubleShooting-and-FAQ/#the-game-has-poor-performance-even-on-high-end-systems)
