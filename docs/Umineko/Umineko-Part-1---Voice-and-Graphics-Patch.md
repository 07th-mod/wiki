...
6. **Select your OS below to see steps specific to your platform!**
...
=== "Mac"
    ...
    > Missing Game Data
    >
    > No game script found. This application must be run from a directory containing NScripter, ONScripter, or Ponscripter game data.
...
Ensure that you have your `0.u`, and your patched `Umineko1to4.exe`, `Umineko1to4`, or `Umineko1to4.app` is present in the root of the game folder.
