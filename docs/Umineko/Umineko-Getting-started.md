...
- Timed text/voice (timed text/voice which appears without you clicking to advance) won't advance automatically in the 'normal' scripts. This is fixed in the experimental scripts.
...
- If you want to play in Japanese, you should use the **experimental scripts** and **NVL** mode ONLY. Playing in Japanese with other options currently have issues.
